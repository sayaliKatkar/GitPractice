...
public class Registration {
  ...
  public static void registerForm(WebDriver driver) throws InterruptedException 
  {
	  ...
	  if((Constants.Gender).equalsIgnoreCase("female"))
	  {
		  driver.findElement(By.id("id_gender2")).click();
		  
	  }
	  
	  else if ((Constants.Gender).equalsIgnoreCase("male"))
	  {
	  ...
	  driver.findElement(By.id("customer_firstname")).sendKeys(Constants.firstName);
	  driver.findElement(By.id("customer_lastname")).sendKeys(Constants.lastName);
